...
describe('dateSortComparator', () => {
  it('returns -1 if aDate is less than bDate', () => {
    const aDate: string = '2017-07-15T08:23:20.000Z'
    const bDate: string = '2017-07-19T08:23:20.000Z'
    expect(dateSortComparator(aDate, bDate)).toBe(-1)
  })
  it('returns 1 if aDate is greater than bDate', () => {
    const aDate: string = '2017-07-17T08:23:20.000Z'
    const bDate: string = '2017-07-15T08:23:20.000Z'
    expect(dateSortComparator(aDate, bDate)).toBe(1)
  })
